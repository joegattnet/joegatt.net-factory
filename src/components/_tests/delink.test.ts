...
test("Changes lone urls to domains", () => {
  expect(
    delink(
      "http://www.slate.com/articles/health_and_science/medical_examiner/2016/06/prince_s_death_reveals_how_wrong_our_over_reliance_on_dangerous_opioids.html today"
    )
  ).toBe("slate.com");
});
